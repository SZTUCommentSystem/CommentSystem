  ...
  <div class="question-bank">
    <div class="filter-container">
      ...
      <el-button type="primary" style="margin-left: 10px;"
        @click="router.push({name: 'questioncreate', query: { type: 0 }})">创建题目</el-button>
    </div>
      ...
      <ElTableColumn label="操作" width="200">
        <template #default="scope">
          <div class="icon-container" style="display: flex; align-items: center;">
            <RouterLink :to="{ name: 'questiondetail', query: { type: 1, itemId: scope.row.topicId } }" @click.stop>
    ...
    <div class="paging mt-4" style="display: flex;justify-content: flex-end;">
      <el-config-provider :locale="zhCn">
        <el-pagination :total="state.total" background layout="total, prev, pager, next, sizes, jumper"
